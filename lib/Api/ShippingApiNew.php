...
class ShippingApiNew
{
    ...
    {
        list($response) = $this->createShipmentWithHttpInfos($body);
        return $response;
    }
    /**旧版下单接口
     ...
     */
    public function createShipmentWithHttpInfos($body)
    {
        $request = $this->createShipmentRequests($body);
        return $this->sendRequests($request, CreateShipmentResponse::class);
    }
    /**
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException
     */
    public function getShipments($shipment_id,$clientId,$format)
    {
        list($response) = $this->getShipmentWithHttpInfos($shipment_id,$clientId,$format);
    ...
    {
        $request = $this->getShipmentRequests($shipment_id);
     ...
     * @throws \ClouSale\AmazonSellingPartnerAPI\ApiException
     */
    public function getShipmentWithHttpInfos($shipment_id,$clientId,$format)
    {
        $request = $this->getShipmentRequestss($shipment_id,$clientId,$format);

        return $this->sendRequests($request, GetShipmentsResponse::class);
    }
    /**
    ...
    //原版的
    protected function getShipmentRequests($shipment_id)
    {
        // verify the required parameter 'shipment_id' is set
        if (null === $shipment_id || (is_array($shipment_id) && 0 === count($shipment_id))) {
    ...
    /**
     * Create request for operation 'getShipment'.//获取面单
     *
     * @param string $shipment_id (required)
     *
     * @throws \InvalidArgumentException
     ...
     * @return mixed
     */
    public function getTrackingInformations($carrierId,$tracking_id)
    {
        list($response) = $this->getTrackingInformationWithHttpInfos($carrierId,$tracking_id);
     ...
     * @return mixed
     */
    public function getTrackingInformationWithHttpInfos($carrierId,$tracking_id)
    {
        $request = $this->getTrackingInformationRequests($carrierId,$tracking_id);

        return $this->sendRequests($request, GetTrackingInformationResponse::class);
    }
    /**
