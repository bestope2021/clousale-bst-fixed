 ...
 */
trait SellingPartnerApiRequests
{
...
//            exit();
     ...
     * @throws ApiException
     */
    private function sendRequests(Request $request, string $returnType): array
    {
        try {
            $options = $this->createHttpClientOption();
            try {
...
//            exit();
            return [
                $content, $response->getStatusCode(), $response->getHeaders(),
            ];
